...
object CurrentOrigin {
  private val value = new ThreadLocal[Origin]() { // java.lang.ThreadLocal
    override def initialValue: Origin = Origin() // 初始值
  }
...
// scalastyle:on
  // 自身类型 selfType  http://stackoverflow.com/questions/1990948/what-is-the-difference-between-self-types-and-trait-subclasses
  // 任何TreeNode的子类在实例化的时候必须混入BaseType类型
  self: BaseType =>
