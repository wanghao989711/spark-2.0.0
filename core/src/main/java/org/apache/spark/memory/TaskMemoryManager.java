 ...
 * <p>
 * This allows us to address 8192(2^13)pages. In on-heap mode, the maximum page size is limited by the
 *
...
public class TaskMemoryManager {
  ...
  private static final int PAGE_TABLE_SIZE = 1 << PAGE_NUMBER_BITS; // 8192
   ...
   *                // long[]最大长度为2^32 - 1,long为8byte
   */
  public static final long MAXIMUM_PAGE_SIZE_BYTES = ((1L << 31) - 1) * 8L;// 16GB
